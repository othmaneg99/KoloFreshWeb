    ...
    <div className='container' >
        ...
        <form action='' autoComplete='off'>
          <div className={styles.formRow}>
            <div className={styles.inputWrap}>
              ...
              <input className={styles.input} type='text' name='nom' id='' onChange={(event)=>{setNom(event.target.value.toUpperCase())}}required />
            </div>
            <div className={styles.inputWrap}>
              <label className={styles.label} htmlFor='prenom'>
                Prénom*
              </label>
              <input className={styles.input} type='text' name='prenom' id='' onChange={(event)=>{setPrenom(capitalizeFirstLetter(event.target.value))}}required />
            </div>
          </div>
          <Box textAlign='center'>
            <ButtonRed onClick={()=>{setStep(2)}} className={styles.btn}>
              Suivant
            </ButtonRed>
          </Box>
        </form>
      ...
      <main  id='step2' className='mainContent'>
        ...
        <form action='' autoComplete='off'>
          ...
          <Box textAlign='center'>
            <ButtonRed onClick={()=>{setStep(3)}} className={styles.btn}>
              Suivant
            </ButtonRed>
          </Box>
        </form>
      ...
      <main  className='mainContent'>
        ...
        <p className={styles.paragraph}>
         ...
         <b style={{color: '#C32530'}}> 24 heures</b> a venir afin de confirmer vos informations et vous communiquer votre <span style={{color: '#C32530'}}>mot de passe</span>.
        </p> 
