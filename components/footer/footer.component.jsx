...
const footerSection = {
  ...
  return <footer className='footer'>
    ...
    <div style={footerSection}>
      ...
      <a href=""><Image src={playstore} alt='playstore' /></a>
      <a href=""><Image src={applestore} alt='applestore' /></a>
      <a href="">CONDITIONS <br />D'UTILISATION</a>
      <a href="">POLITIQUE DE <br />CONFIDENTIALITE</a>
